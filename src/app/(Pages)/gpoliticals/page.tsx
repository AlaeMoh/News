"use client"
import { fetchGoogleElectricNews, fetchGooglePoliticalNews } from '@/app/service/api';
...
export default function Page() {
    ...
    const [politicals, setpolitical]= useState<Article[]>([])
    useEffect(()=>{
        const fetchData = async ()=>{
            try{
                const googlePolitical = await fetchGooglePoliticalNews()
                setpolitical(googlePolitical)
                console.log(googlePolitical)
            }catch(error){
